...
# 12. Faça um programa que compare se dois números fornecidos pelo usuário são iguais.
primeiro_numero = input("Digite um número: ").lower()
segundo_numero = input("Digite outro mesmo número: ").lower()
primeiro_numero = (primeiro_numero == "true")
segundo_numero = (segundo_numero == "true")
numero_igual = primeiro_numero or segundo_numero
print(f"Os números são iguais? {numero_igual}")
